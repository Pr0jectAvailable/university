...
#define THROW02 "Create: превышен размер максимальной ёмкости словаря словаря"
#define THROW03 "AddEntry: переполнение словаря"
#define THROW04 "AddEntry: дублирование идентификатора"
#define THROW05 "GetEntry: не найден эллемент"
#define THROW06 "DelEntry: не найден эллемент"
#define THROW07 "UpdEntry: не найден эллемент"
